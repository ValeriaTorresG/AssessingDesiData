...
def main(argv=None):
    ...
    parser.add_argument('--fiber_plot',       default='/pscratch/sd/v/vtorresg/umap_analysis/data/sep_bands/z/plots')
    parser.add_argument('--out_txt',          default='/pscratch/sd/v/vtorresg/umap_analysis/data/sep_bands/z/text_files')
    ...
    parser.add_argument('--out_log',         default='/pscratch/sd/v/vtorresg/umap_analysis/data/sep_bands/z')
